    ...
    for m in moves {
        ...
        for n in 0..distance {
            ...
            if vertical_offsets[cur_x as usize] > cur_y { // underflow aka go up
                ...
                cur_y = (vertical_offsets[cur_x as usize]  as usize + vertical_lengths[cur_x as usize] as usize) as i32; // loop back around
            }
            ...
            if line_offsets[cur_y as usize] > cur_x {
                cur_x = line_offsets[cur_y as usize]  as i32 + game_map[cur_y as usize].len() as i32; // loop to the right when going left
            }
