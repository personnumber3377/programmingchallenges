...
fn parse_input() -> (Vec<Vec<i32>>, Vec<i32>, Vec<i32>, Vec<i32>, Vec<i32>, Vec<i32>) {
    ...
    for x_count in 0..out_map[0].len() {  // loop through all columns
        ...
        horizontal_lengths.push(y_count);
...
fn main_loop(game_map: Vec<Vec<i32>>, line_offsets: Vec<i32>, mut moves: Vec<i32>, move_lenghts: Vec<i32>, horizontal_offsets: Vec<i32>, horizontal_lengths: Vec<i32>) {
